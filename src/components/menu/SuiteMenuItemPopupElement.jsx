...
class SuiteMenuItemPopupElement extends Component {
    ...
    render() {
        ...
        return (
            <div className="modal modal-fixed-footer" id={'suiteMenuItemPopupModal' + item.PlaceMenuTree.id} style={modal}>
                <div className="modal-content" style={content}>
                    <div className="row">
                        ...
                        <div className="col m5 l3">
                            <SuiteMenuItemActionElement customer={customer} item={item} suite={suite}/>
                        </div>
                    </div>
                </div>
    ...
    componentDidMount() {
        ...
        // Initialize menu item modal popup window
        $('#trigger-modal' + item.PlaceMenuTree.id).leanModal({
...
export default SuiteMenuItemPopupElement;
