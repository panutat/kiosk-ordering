...
gulp.task('font', function () {
    src.assets = ['src/assets/font/**'];
    // Out Put Location
    var out = DEST + '/assets/font';
...
gulp.task('build', ['clean'], function (cb) {
    watch = true;
    runSequence(['assets', 'js', 'png', 'font', 'pages', 'bundle'], function () {
        // If watch flag is set
        if (watch) {
            gulp.watch(src.assets, ['assets']);
            gulp.watch(src.assets, ['js']);
            gulp.watch(src.assets, ['png']);
            gulp.watch(src.assets, ['font']);
